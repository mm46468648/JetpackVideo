package com.example.lib_navcompiler;
...
@SupportedAnnotationTypes({"com.example.lib_annotation.ActivityDestination", "com.example.lib_annotation.FragmentDestination"})
