...
import com.example.lib_common.utils.FileUploadManager;
import com.example.lib_common.utils.FileUtils;
import com.example.lib_common.utils.PixUtils;
import com.example.lib_common.view.ViewHelper;
...
import com.example.mjetpack.databinding.LayoutCommentDialogBinding;
import com.example.mjetpack.model.Comment;
import com.example.mjetpack.ui.login.UserManager;
import com.example.mjetpack.ui.publish.CaptureActivity;
...
//        });
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.comment_send) {
            ...
            CaptureActivity.Companion.startActivityForResult(getActivity());
